...
const ownerNumber = ['254114127157']
...
console.log("dave md is connecting to whatsaap");
...
const path = require('path');
fs.readdirSync("./dave/").forEach((plugin) => {
if (path.extname(plugin).toLowerCase() == ".js") {
require("./dave/" + plugin);
}
});
console.log('Succesfully Installed')
console.log('dave Connected Enjoy')

let up = `thanks for using 𝐀𝐒𝐓𝐀𝐁𝐎𝐓
please follow my channel 
https://whatsapp.com/channel/0029VavpWUvGk1Fkbzz0vz0v`;
conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/99GF2n5y/b2f05b84c9f29bd4.jpg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("254114127157")){
if(isReact) return
m.react("")
}
if(senderNumber.includes("254114127157")){
